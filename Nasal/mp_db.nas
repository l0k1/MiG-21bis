...
var aircraft_lookup = {
    ...
    "m2000-5B-backseat": {parents: [aircraft_arch], rcs: 0.0000001},
    ...
    "A-10-model":        {parents: [aircraft_arch], rcs: 23.5, class: AIR,},
    "A-10-modelB":       {parents: [aircraft_arch], rcs: 23.5, class: AIR,},
    ...
    "Jaguar-GR1":        {parents: [aircraft_arch], rcs: 6, class: AIR,},
    "Jaguar-GR3":        {parents: [aircraft_arch], rcs: 6, class: AIR,},
    ...
    "gci":               {parents: [aircraft_arch], rcs: 50, class: SURFACE,},
    "s-300":             {parents: [aircraft_arch], rcs: 17, class: SURFACE,},
    "struct":            {parents: [aircraft_arch], rcs: 170, class: SURFACE,},
    "rig":               {parents: [aircraft_arch], rcs: 500, class: SURFACE,},
    "point":             {parents: [aircraft_arch], rcs: 120, class: SURFACE,},
    "tower":             {parents: [aircraft_arch], rcs: 60, class: SURFACE,},
    "USS-NORMANDY":      {parents: [aircraft_arch], rcs: 450, class: MARINE,},
    "USS-LakeChamplain": {parents: [aircraft_arch], rcs: 450, class: MARINE,},
    "USS-OliverPerry":   {parents: [aircraft_arch], rcs: 450, class: MARINE,},
    "USS-SanAntonio":    {parents: [aircraft_arch], rcs: 450, class: MARINE,},
};
